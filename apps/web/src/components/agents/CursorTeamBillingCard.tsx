...
// merged into it: these are monetary billing-cycle values (spend, hard
// limit), not individual runtime quota, and are never shown as token
// percentages or 5H/1W windows.

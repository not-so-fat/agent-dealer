...
- Before any playbook or deck-backed tool is used, the selected deck is bound to the actual generated worktree path and verified. Binding failure stops the worker; there is no silent fallback to an unbound/default deck.
